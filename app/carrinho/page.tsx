          ...
          <>
            ...
            >
              {items.map((item) => (
                ...
                >
                  ...
                  >
                    <button onClick={() => decreaseItem(item.id)} style={btnStyle}>
                      -1
                    </button>

                    <button onClick={() => increaseItem(item.id)} style={btnStyle}>
                      +1
                    </button>

                    <button onClick={() => removeItem(item.id)} style={dangerBtnStyle}>
                      Remover
                    </button>
                  </div>
                </div>
            ...
            >
              <div>
                ...
                >
                  Continue para a encomenda final
                </div>
              </div>
